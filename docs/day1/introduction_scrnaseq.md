...
```sh
wget https://single-cell-transcriptomics.s3.eu-central-1.amazonaws.com/scRNAseq.tar.gz
tar -xvf scRNAseq.tar.gz
rm scRNAseq.tar.gz
```
...
```
./data
├── DEG_astrocytes_vs_macrophages.rds
├── c2.cp.kegg.v7.2.symbols.xls
...
!!! bug
    Add information on origin of the data here
