...
seu_int_monocl <- monocle3::new_cell_data_set(Seurat::GetAssayData(seu_int,
                                                                   assay = "joined",
                                                                   slot = "counts"),
...
```{r}
#| echo: false
seu_int_monocl <- monocle3::order_cells(seu_int_monocl, root_pr_nodes = c("Y_156", "Y_195", "Y_215", "Y_223", "Y_231"))
```
...
```{r}
#| echo: false
cls <- clusters(seu_int_monocl) 
seuB <- seu_int_monocl[, names(cls)[cls %in% c(10, 3, 11)]]
```
