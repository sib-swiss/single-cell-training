...
{{< downloadthis ../assets/pdf/02_introduction_scRNAseq.pdf dname="introduction_scRNAseq" label="Download the presentation" icon="filetype-pdf" >}}

{{< video https://youtu.be/_ND6pEsf5Kg?si=BXzovujSUkWJ7x4h >}}

{{< downloadthis ../assets/pdf/03_10x_genomics_single_cell.pdf dname="10x_genomics_single_cell" label="Download the presentation" icon="filetype-pdf" >}}
...
```sh
export PATH=/data/cellranger-7.2.0:$PATH
```
